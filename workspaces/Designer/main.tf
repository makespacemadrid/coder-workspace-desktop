...
resource "coder_agent" "main" {
  ...
  startup_script = <<-EOT
    ...
    mkdir -p ~/Desktop
    for f in firefox.desktop freecad.desktop inkscape.desktop org.gimp.GIMP.desktop krita.desktop kicad.desktop openscad.desktop prusa-slicer.desktop librecad.desktop meshlab.desktop visicut.desktop geany.desktop; do
